...
<html lang="en">
    ...
    <head>
        ...
        <title>Employee Dashboard - Update product</title>
                    ...
                    <div class="page-title">
                        <div class="row">
                            <div class="col-12 col-md-6 order-md-1 order-last">
                                ...
                                <p class="text-subtitle text-muted">For update a product - Employee</p>
                            </div>
                            <div class="col-12 col-md-6 order-md-2 order-first">
                                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Catalog - Product - Update product</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">Product ID: ${pid}</h4>
                                    </div>
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="first-name-column" class="form-control"
                                                                   placeholder="Product name" name="pname" required="" value="${prd.productName}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea id="description" class="form-control" required=""
                                                                      placeholder="Product description" name="description">${prd.desscription}</textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3 col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" id="first-name-column" class="form-control" required=""
                                                                   placeholder="Import price" name="iprice" value="${prd.importPrice}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3 col-6">
                                                        <div class="form-group">
                                                            <label for="first-name-column">Unit price</label>
                                                            <input type="number" id="first-name-column" class="form-control" required=""
                                                                   placeholder="Unit price" name="uprice" value="${prd.unitPrice}">
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="box-upload">
                                                                <div class="upload__box">
                                                                    ...
                                                                    <div class="upload__img-wrap">
                                                                        <c:forEach items="${prd.images}" var="pi">
                                                                            <div class='upload__img-box'>

                                                                                <div style='background-image: url("img/shoes/${pi.url}")' data-number='" + $(".upload__img-close").length + "' data-file='" + ${pi.imageId} + "' class='img-bg'>
