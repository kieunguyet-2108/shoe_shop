            ...
            <div id="main">
                ...
                <div class="page-heading">
                    ...
                    <div class="table-filter">
                            <div class="row">
                                <div  class="col-sm-10">
                                    <form action="EmployeeManageSubcategory" method="post">
                                                    ...
                                                    <c:forEach items="${listSubCate}" var="s">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="EmployeeUpdateCategory?subid=${s.getSubCategoryId()}&subname=${s.getSubCategoryName()}&description=${s.getDescription()}&status=${s.getStatus()}&cateId=${cateId}" class="btn btn-success">Edit</a></td>
                                                        </tr>
                                                    </c:forEach>
                                                </tbody>
                                            </table>
