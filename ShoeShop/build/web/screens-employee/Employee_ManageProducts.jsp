                                ...
                                <div class="card">
                                    <form action="" class="card-content">
                                                                                ...
                                                                                <div class="modal-body bg-light-info">
                                                                                    <div class="d-flex">
                                                                                        <div style="flex: 38">
                                                                                            ...
                                                                                            <p>Unit price: <span style="font-weight: 500">${p.getUnitPriceVN()}</span> </p>
                                                                    ...
                                                                    <div class="modal fade text-left" id="dlp${p.productId}" tabindex="-1" aria-labelledby="myModalLabel120" aria-hidden="true" style="display: none;">
                                                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-footer">
                                                                                    <a onclick="deleteRow(${p.productId})" type="button" class="btn btn-danger ml-1"
                                                                                       >
                                        ...
                                        <div style="display: flex; justify-content: space-between">
                                            <input type="submit" name="action" class="btn btn-outline-danger " value="Delete selected products">
