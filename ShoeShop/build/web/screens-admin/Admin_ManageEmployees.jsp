                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Accounts - Employees</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-content">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>1</td>
                                                    <td class="text-bold-500">${e.getEmployeeName()}</td>
                                                    <td>thanh@gmail.com</td>
                                                    <td class="text-bold-500">${e.getAddress()}</td>
                                    ...
                                    <a href="AdminAddEmployee" class="btn btn-info">Add new</a>
                                </div>
                            </div>
                        </div>
                    </div>
