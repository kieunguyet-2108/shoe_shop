                    ...
                    <div class="col-lg-8">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-4 ">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                <input type="text" class="form-control"
                                                       value="${profile.getCustomerName()}" disabled>
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                            <div class="col-sm-3">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                <input type="tel" class="form-control"
                                                       value="${profile.getPhoneNumber()}" disabled>
                                            </div>
                                        </div>
                                                            ...
                                                            <div class="modal-body mx-3">
                                                                <div class="md-form mb-4">
                                                                    ...
                                                                    <input type="text"
                                                                           ...
                                                                           name="name"
                                                                           value="${profile.getCustomerName()}" required="">
                                                                </div>
                                                                <div class="md-form mb-4">
                                                                    <label data-error="wrong"
                                                                           data-success="right"
                        ...
                        <c:if test="${action == 'show_address'}">
                            <div class="card">
                                ...
                                <div class="row mb-5  mx-2 border-bottom ml-4">
