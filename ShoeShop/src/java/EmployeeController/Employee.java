...
public class Employee extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("completionRate", Math.round((oDao.getNumberOfOrders(3)*1.0/oDao.getNumberOfOrders())*100)+"%");
        ...
        request.setAttribute("profit", oDao.getProfitVND());
        Locale localeVN = new Locale("vi", "VN");
        NumberFormat currencyVN = NumberFormat.getCurrencyInstance(localeVN);
        request.setAttribute("capital", currencyVN.format(oDao.getRevenue()-oDao.getProfit()));
        request.setAttribute("profitMargin", Math.round(oDao.getProfit()/oDao.getRevenue()*100)+"%");
