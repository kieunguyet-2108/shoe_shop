...
public class BrandDAO extends DBContext {
    ...
    public ArrayList<Brands> getListBrands() {
        ...
        try {
            String sql = "select * from Brands where Status = 'activate' ";
    ...
    public void updateBrand(String name, String des, String status, String brandId) {
        try {
            String sql = "update Brands set BrandName = ?, BrandDescription = ?, Status = ? where brandId = ?";
            PreparedStatement stm = connection.prepareStatement(sql);
    ...
    public void insertBrand(String name, String des) {
        try {
            String sql = "insert into Brands (BrandName, BrandDescription, CreatedAt, Status) VALUES (?,?, GETDATE(),'activate')";
            PreparedStatement stm = connection.prepareStatement(sql);
            stm.setString(1, name);
            stm.setString(2, des);
            stm.executeUpdate();
